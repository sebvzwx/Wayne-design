      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10 w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          {PROJECTS.map((project, index) => (
            ...
            >
              {/* Card Container - Highly Rounded Widget Style */}
              <div className="relative h-full w-full rounded-2xl sm:rounded-3xl md:rounded-4xl overflow-hidden border border-white/10 transition-all duration-500 ease-out group-hover:shadow-[0_20px_60px_-15px_rgba(46,92,255,0.3)] group-hover:-translate-y-2 bg-[#111]">
